...
function SubCategories() {
    ...
    useEffect(()=> {
      if(localStorage.getItem('subcategory')){
        var userData = JSON.parse(localStorage.getItem('subcategory'))
        ...
        <SoftBox mb={3}>
          <Card>
            <SoftBox display="flex" justifyContent="space-between" alignItems="center" p={3}>
              <SoftTypography variant="h6">Sub Category List
	                    ...
	                    <tr key={idx}>
                            ...
                            <td>
                                <SoftTypography variant="caption" color="secondary" className="cursor-pointer" fontWeight="medium"
                                  onClick={() => { 
                                    localStorage.setItem('editSubCategory', JSON.stringify(cat))
                                  ...
                                  onClick={() => { 
                                    Swal.fire({
                                      ...
                                      if (result.isConfirmed) {
                                        ...
                                        localStorage.setItem('subcategory', JSON.stringify(categoryList))
                                ...
                                <SoftTypography ml={1} variant="caption" color="secondary" className="cursor-pointer" fontWeight="medium"
                                  onClick={() => { 
                                    localStorage.setItem('viewSubCategory', JSON.stringify(cat))
